 ...
 * que ainda não foi atualizado ou ainda as threads executarem depois do valor estar
 * impresso.
 * 
...
public class Programa {
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println("Saldo da conta (SEM Synchronized) R$ " + c1.getSaldo());
		...
		System.out.println("Saldo da conta (COM Synchronized) R$ " + c1.getSaldo());	
	}
}