...
public class Programa {
	public static void main(String[] args) {
		...
		// VRIFICANDO SE CONTÉM		
		System.out.println("Contem na lista Paulo: " + lista.contem("Paulo"));
		System.out.println("Contem na lista Paulinho: " + lista.contem("Paulinho"));
		System.out.println("Contem na lista Brasil: " + lista.contem("Brasil"));
