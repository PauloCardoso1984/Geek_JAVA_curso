...
public class Funcao {
	...
	public static void main(String[] args) {
		...
		System.out.println("Faça um programa que receba diversos nomes de frutas do usuário e imprima essas frutas.");
		System.out.println();
	 ...
	 * d) Retorno (Opcinal) - depende de retorno => void = vazio, não retorna nada
	 */
	...
	static void mostrar_dados_invertida(int quantidade) {
	...
	static void mostrar_dados_normal(int quantidade) {
		// For para imprimir os dados na sequância normal
		for (int i = 0; i < quantidade; i++) { 
			System.out.println(frutas[i]);
		}
	}
