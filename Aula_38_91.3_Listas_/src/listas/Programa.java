...
public class Programa {
	...
	public static void main(String[] args) {
		...
		Cliente cli1 = new Cliente(189988745, "Paulo Reginaldo", "Rua 1");
		Cliente cli2 = new Cliente(495456165, "Paulo Cardoso", "Rua 10");
		Cliente cli3 = new Cliente(125641514, "Cardoso Paulo", "Rua 5");
		...
		System.out.println("Imprimir na ordem cadastrada:");
		for (Cliente cliente : clientes) {
			System.out.println(cliente);
		}
		System.out.println();

		// Imprimir em ordem crescente por CPF
